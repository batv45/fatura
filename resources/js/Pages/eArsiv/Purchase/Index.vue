<template>
    <AppLayout title="Alış Faturaları">
        <PageHeader title="Alış Faturaları" sub-title="eArsiv sisteminde kayıtlı faturalarınız."></PageHeader>
...
const searchResult = computed(() => {
    if( searchText.value ){
        return props.page_invoices.filter(f =>
            f.saticiUnvanAdSoyad.toLocaleLowerCase('tr-TR').includes(searchText.value.toLocaleLowerCase('tr-TR')) ||
            f.saticiVknTckn.includes(searchText.value) ||
